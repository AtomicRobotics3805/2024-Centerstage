...
object Lid: Subsystem {
    var NAME = "claw"
    var INTAKE_POSITION = 0.12
    var CLOSE_POSITION = 0.01
    var DROP_POSITION = 0.05
    var SLIGHTLY_LARGER_DROP = 0.06

    /* Isaac's new claw
    var INTAKE_POSITION = 0.27
    var CLOSE_POSITION = 0.5
    var DROP_POSITION = 0.27
     */
    var TIME = 1.0
    ...
    val slightlyBigger: Command
        get() = MoveServo(clawServo, SLIGHTLY_LARGER_DROP, TIME)
}